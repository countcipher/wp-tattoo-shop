...
$after_care_content = get_field('after_care_content');
...
<!--HERO
=================================-->
   <section id="hero" class="page-hero after-care-hero">
...
<!--AFTER-CARE
====================================-->
    <section class="navTrigger after-care">
        <div class="container-fluid">
            <div class="row">
                
              <?php echo $after_care_content; ?>
